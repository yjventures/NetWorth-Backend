...
const webfrontController = require('../controller/webFrontController');
...
router.get('/admin/personal-info', authVerifyMiddleware.adminMiddleware, adminController.getAdminPersonalInfo);
...
router.put('/card/cancel-incoming-request', authVerifyMiddleware.authMiddleware, connectionController.cancelIncomingRequest);

router.put('/card/cancel-outgoing-request', authVerifyMiddleware.authMiddleware, connectionController.cancelOutgoingRequest);

router.get('/card/:id/incoming-request', authVerifyMiddleware.authMiddleware, connectionController.showInComingRequestList);

router.get('/card/:id/outgoing-request', authVerifyMiddleware.authMiddleware, connectionController.showOutGoingRequestList);
...
router.get('/user/average-point', authVerifyMiddleware.authMiddleware, userController.averagePointData);
router.get('/users/rankings', authVerifyMiddleware.authMiddleware, userController.topRankings);
router.put('/admin/personal-info', authVerifyMiddleware.adminMiddleware, adminController.updateAAdminPersonalInfo);

router.get('/admin/signup-statistic', authVerifyMiddleware.adminMiddleware, adminController.targetSignupStatistic);

router.get('/card/check-friend', connectionController.checkCardInFriendListOrNot);
...
router.post('/invitation/via-email', authVerifyMiddleware.authMiddleware, connectionController.sendInvitationViaEmail);

router.put('/connection-via-qr', authVerifyMiddleware.authMiddleware, connectionController.friendViaQrCode);

router.get('/user/token-verify', authVerifyMiddleware.authMiddleware, userController.checkExistingUserByToken);
