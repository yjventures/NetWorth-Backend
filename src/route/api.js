...
router.get(
    '/search/:cardId',
    authVerifyMiddleware.authMiddleware,
    connectionController.searchContact,
)
...
router.put(
    '/card/temp-card-unfriend',
    connectionController.unfriendTempCardMutualFriend,
)
...
router.get(
    '/user/token-verify',
    authVerifyMiddleware.authMiddleware,
    userController.checkExistingUserByToken,
)
...
router.post(
    '/admin/webfront',
    authVerifyMiddleware.adminMiddleware,
    webfrontController.createWebFront,
)
